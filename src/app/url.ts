...
// SERVER
export const baseUrlVehicle = 'https://fleet-management-backend.herokuapp.com/vehicles';
export const baseUrlOrder = 'https://fleet-management-backend.herokuapp.com/orders';
export const baseUrlPlanner = 'https://fleet-management-backend.herokuapp.com/planner';
...
// export const baseUrlVehicle = 'http://localhost:3000/vehicles';
// export const baseUrlOrder = 'http://localhost:3000/orders';
